...
export const LIST_PRODUCT_SAMPLE: Product[] = [
    {
        id: "omega3-fish-oil",
        title: "Thực phẩm chức năng Dầu Cá Omega-3 Blackmores 1000mg 200 Viên",
        images: [
            require('../images_sp/dau_ca_omega.png'),
            require('../images_sp/magie_blackmores.png'),
            require('../images_sp/dau_ca_omega.png'),
    ...
    {
        id: "calcium-vitamin-d3",
        title: "Viên uống bổ sung Canxi và Vitamin D3 Ostelin 300 Viên",
        images: [
            require('../images_sp/magie_blackmores.png'),
            require('../images_sp/dau_ca_omega.png'),
            require('../images_sp/magie_blackmores.png'),
    ...
    {
        id: "glucosamine-joint-care",
        title: "Thực phẩm chức năng Glucosamine Chondroitin MSM 120 Viên",
        images: [
            require('../images_sp/dau_ca_omega.png'),
            require('../images_sp/magie_blackmores.png'),
            require('../images_sp/dau_ca_omega.png'),
